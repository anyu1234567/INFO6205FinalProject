...
public class PureHuskySort<X extends Comparable<X>> {
    ...
    public static void main(final String[] args) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            sorter.sort(alphaBetaArray);//（unicode instead of ASCII words when sort Chinese）
        }
