...
public class QuickSort_DualPivotBenchmark {
    final static LazyLogger logger = new LazyLogger(QuickSort_DualPivotBenchmark.class);
    ...
    private void doSortStrings(final int n, final int m) {
        benchmarkStringSorters(COMMON_CHINESE_WORDS_CORPUS, QuickSort_DualPivotBenchmark.getWords(COMMON_CHINESE_WORDS_CORPUS, QuickSort_DualPivotBenchmark::lineAsList), n, m,new PinyinHelper());
    }
    ...
    void benchmarkStringSorters(final String corpus, final String[] words, final int nWords, final int nRuns, Helper helper) {
        ...
        final boolean purehuskysortwithinsertionsort = false;
        final QuickSort_DualPivot quickSort_dualPivot = new QuickSort_DualPivot(helper);
        final String s1 = "QuickSort_DualPivot" + (purehuskysortwithinsertionsort ? " with insertion sort" : "");
        final Benchmark<String[]> benchmark = new Benchmark<>(getDescription(nWords, s1, s2), null, quickSort_dualPivot::sort, null);
